...
- [x] T004 Configure Supabase Storage bucket policies for gallery folder (manual - Supabase dashboard) *(docs/supabase-storage-setup.md + scripts/setup-supabase-storage.sql ready)*
