...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_chat_rooms_category"), "chat_rooms", ["category"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_forum_categories_name"), "forum_categories", ["name"], unique=True
    )
    op.create_index(
        op.f("ix_forum_categories_slug"), "forum_categories", ["slug"], unique=True
    )
    op.create_table(
        "users",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_authenticators_user_id"), "authenticators", ["user_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_community_groups_name"), "community_groups", ["name"], unique=True
    )
    op.create_table(
        "content_reports",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_content_reports_content_id"),
        "content_reports",
        ["content_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_content_reports_content_type"),
        "content_reports",
        ["content_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_conversations_user_one_id"),
        "conversations",
        ["user_one_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_conversations_user_two_id"),
        "conversations",
        ["user_two_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["category_id"], ["forum_categories.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_forum_threads_author_id"), "forum_threads", ["author_id"], unique=False
    )
    op.create_index(
        op.f("ix_forum_threads_category_id"),
        "forum_threads",
        ["category_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_forum_threads_last_activity"),
        "forum_threads",
        ["last_activity"],
        unique=False,
    )
    op.create_index(
        op.f("ix_forum_threads_report_count"),
        "forum_threads",
        ["report_count"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_profiles_location_city"), "profiles", ["location_city"], unique=False
    )
    op.create_index(
        op.f("ix_profiles_location_state"), "profiles", ["location_state"], unique=False
    )
    op.create_index(
        "ix_profiles_roles_gin",
        "profiles",
        ["roles"],
        unique=False,
        postgresql_using="gin",
    ...
    op.create_index(
        op.f("ix_relationships_from_user_id"),
        "relationships",
        ["from_user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_relationships_to_user_id"),
        "relationships",
        ["to_user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_forum_posts_author_id"), "forum_posts", ["author_id"], unique=False
    )
    op.create_index(
        op.f("ix_forum_posts_parent_id"), "forum_posts", ["parent_id"], unique=False
    )
    op.create_index(
        op.f("ix_forum_posts_report_count"),
        "forum_posts",
        ["report_count"],
        unique=False,
    )
    op.create_index(
        op.f("ix_forum_posts_thread_id"), "forum_posts", ["thread_id"], unique=False
    )
    op.create_table(
        "group_memberships",
        sa.Column("id", sa.UUID(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["group_id"], ["community_groups.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_index(
        op.f("ix_status_updates_author_id"),
        "status_updates",
        ["author_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_status_updates_created_at"),
        "status_updates",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_status_updates_group_id"), "status_updates", ["group_id"], unique=False
    )
    op.create_index(
        op.f("ix_status_updates_report_count"),
        "status_updates",
        ["report_count"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_post_comments_author_id"), "post_comments", ["author_id"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_messages_created_at_brin", table_name="messages", postgresql_using="brin"
    )
    ...
    op.drop_index(
        "ix_profiles_roles_gin", table_name="profiles", postgresql_using="gin"
    )
    ...
    op.drop_index(
        "ix_profiles_interests_gin", table_name="profiles", postgresql_using="gin"
    )
    ...
    op.drop_index(
        "ix_authenticators_user_id_credential_id", table_name="authenticators"
    )
