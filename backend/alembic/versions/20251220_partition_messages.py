...
down_revision: Union[str, Sequence[str], None] = "3fc18fd104d4"
...
def downgrade() -> None:
    ...
    """)
    op.execute(
        "INSERT INTO messages (id, room_id, conversation_id, sender_id, content, type, created_at) SELECT id, room_id, conversation_id, sender_id, content, type, created_at FROM messages_partitioned;"
    )
