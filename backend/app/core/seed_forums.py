...
async def seed_categories():
    categories = [
        ...
        },
        {
            ...
            "slug": "health",
            "description": "Discussions on physical and mental health.",
        },
        {
            "name": "Local Events",
            "slug": "events",
            "description": "Find and share local community events.",
        },
        {
            "name": "Hot Topics",
            "slug": "hot-topics",
            "description": "Trending and controversial discussions.",
        },
        {
            "name": "Support",
            "slug": "support",
