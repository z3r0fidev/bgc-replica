    ...
    await page.route('**/api/gallery/albums/album-1', async (route) => {
      await route.fulfill({
        ...
        body: JSON.stringify({
          ...
          media_count: 3,
          media: [
            { id: 'm1', type: 'IMAGE', url: 'img1.jpg', privacy: 'PUBLIC', view_count: 0, created_at: new Date().toISOString() },
            { id: 'm2', type: 'IMAGE', url: 'img2.jpg', privacy: 'PUBLIC', view_count: 0, created_at: new Date().toISOString() },
            { id: 'm3', type: 'IMAGE', url: 'img3.jpg', privacy: 'PUBLIC', view_count: 0, created_at: new Date().toISOString() },
          ],
          created_at: new Date().toISOString(),
        }),
      });
